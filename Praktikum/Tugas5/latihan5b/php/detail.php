        ...
        <div class="card border border-primary" style="max-width: 540px;">
            <div class="row no-gutters">
                <div class="col-md-4 mt-3 pl-2">
                    <img src="../assets/Gambar/<?= $books["Picture"]; ?>" class="card-img border border-dark">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title m-1"><?= $books["Name"] ?></h5>
                            <ul>
                                <li class="card-text"><?= $books["Description"] ?></li>
                                <li class="card-text"><?= $books["Size"] ?></li>
                                <li class="card-text"><?= $books["Price"] ?></li>
                                <li class="card-text"><?= $books["Category"] ?></li>
                            </ul>
